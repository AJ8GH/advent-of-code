...
public class Main {
  ...
  private static final String EXAMPLE = "./src/main/resources/io.github.aj8gh.aoc.y21.day6/example.txt";
  private static final String INPUT = "./src/main/resources/io.github.aj8gh.aoc.y21.day6/input.txt";
