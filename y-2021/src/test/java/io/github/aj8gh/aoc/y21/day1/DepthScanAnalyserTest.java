...
class DepthScanAnalyserTest extends ReaderProvider {
  private static final int DAY_1 = 1;

  @ParameterizedTest
  @MethodSource(value = "inputProviderPart1")
  void getNumberOfDepthIncreases_Part1(List<Integer> input, int expected) {
  ...
  void getThreeDepthWindows_Part2(List<Integer> input, int expected) {
    var analyser = new DepthScanAnalyser();
